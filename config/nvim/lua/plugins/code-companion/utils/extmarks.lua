...
--- @field id string|number Unique identifier for the request
--- @field context CodeCompanion.InlineContext Context information about the code block

--- @class CodeCompanion.InlineContext
--- @field bufnr number Buffer number where the code block is located
--- @field start_line number Starting line of the code block (1-indexed)
--- @field end_line number Ending line of the code block (1-indexed)
...
local function start_spinners(bufnr, ns_id, start_line, end_line)
  local block_spinner = require('plugins.code-companion.utils.block_spinner').new {
    bufnr = bufnr,
    ns_id = ns_id,
